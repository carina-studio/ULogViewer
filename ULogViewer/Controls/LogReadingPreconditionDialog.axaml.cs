...
class LogReadingPreconditionDialog : AppSuite.Controls.InputDialog
{
    ...
    static readonly StyledProperty<bool> IsTimestampRangeValidProperty = AvaloniaProperty.Register<LogReadingPreconditionDialog, bool>(nameof(IsTimestampRangeValid), true);
    ...
    // Check whether timestamp range is valid or not.
    bool IsTimestampRangeValid => this.GetValue(IsTimestampRangeValidProperty);
