...
class DequeueToVarEditorDialog : AppSuite.Controls.InputDialog<IULogViewerApplication>
{
	...
	/// </summary>
	public DequeueToVariableAction? Action { get; init; }
	...
	protected override void OnEnterKeyClickedOnInputControl(Control control)
	{
		...
		if (ReferenceEquals(control, this.queueTextBox))
		{
			if (!string.IsNullOrWhiteSpace(this.queueTextBox.Text))
			{
