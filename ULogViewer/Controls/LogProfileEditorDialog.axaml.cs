			    ...
			    && !this.Application.ProductManager.IsProductActivated(Products.Professional))
			{
				await new MessageDialog
				{
					...
					Message = new FormattedString().Also(it =>
					{
						...
						it.Bind(FormattedString.FormatProperty, this.Application.GetResourceObservable("String/LogProfileEditorDialog.CannotEditLogProfileWithProVersionOnlyParams"));
					}),
				}.ShowDialog(this);
