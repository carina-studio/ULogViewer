...
/// Log profile.
/// </summary>
class LogProfile : BaseProfile<IULogViewerApplication>, IEquatable<LogProfile>, ILogProfileIconSource
{
	// Constants.
	...
	public string? Description
	{
		...
		set
		{
			...
			this.HasDescription = (value is not null);
	...
	/// <inheritdoc/>
	public bool Equals(LogProfile? other) =>
		...
		foreach (var jsonProperty in element.EnumerateObject())
		{
			switch (jsonProperty.Name)
			{
				...
				case nameof(Description):
					...
					this.hasDescription = (this.description is not null);
					break;
				...
				case "TimestampFormatForReading":
					this.timestampFormatsForReading = [ jsonProperty.Value.GetString().AsNonNull() ];
					this.IsDataUpgraded = true;
					break;
	...
	/// Equality operator.
	/// </summary>
	/// <param name="left">Left profile.</param>
	/// <param name="right">Right profile.</param>
	/// <returns>True if log profiles are equivalent.</returns>
	public static bool operator ==(LogProfile? left, LogProfile? right) =>
	...
	/// <param name="left">Left profile.</param>
	/// <param name="right">Right profile.</param>
	/// <returns>True if log profiles are not equivalent.</returns>
	public static bool operator !=(LogProfile? left, LogProfile? right) =>
		!(left?.Equals(right) ?? right is null);
	...
	void UpdateBuiltInNameAndDescription()
	{
		...
		if (this.description != description)
		{
			...
			this.HasDescription = (description is not null);
			this.OnPropertyChanged(nameof(Description));
		}
	}
