...
若您透過原始碼自行建置 ULogViewer，您使用該建置之版本僅受 [MIT](https://github.com/carina-studio/ULogViewer/blob/master/LICENSE) 授權之約束，不受本隱私權政策之約束。

本隱私權政策適用於您使用 ULogViewer 2026.0 及下一份隱私權政策所指定之版本之間 (但不包括) 的所有版本。
...
+ 應用程式錯誤的詳細資訊。
+ 您在 ULogViewer 中所輸入的 **日誌文字篩選字詞**。
+ ULogViewer 確認是否有應用程式更新時，您的 **IP 位址**、**作業系統**及 **CPU 資訊**可能會被分享至 [GitHub](https://github.com)。關於 GitHub 如何處理這些資料，請參閱 [GitHub 隱私聲明](https://docs.github.com/zh/site-policy/privacy-policies/github-general-privacy-statement)。
...
+ **日誌文字篩選字詞**將儲存在您電腦中 ULogViewer 目錄內的資料庫。

## 個人資訊之使用
+ **日誌文字篩選字詞**用於在篩選日誌時提供自動完成建議。
