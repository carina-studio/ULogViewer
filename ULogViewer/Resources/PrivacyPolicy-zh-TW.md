...
+ 使用 ULogViewer 時的**使用資料**，包括匿名的工作階段識別碼、功能使用事件（例如重新讀取日誌、套用日誌分析、變更圖表類型、日誌類型操作）以及配置指標（例如日誌檔案個數、日誌行格式數量、日誌分析規則數量）。
...
+ **使用資料**將儲存至 [Azure](https://azure.microsoft.com/en-us/)。
...
+ **使用資料**用於了解 ULogViewer 功能的使用情況，以改善應用程式。
