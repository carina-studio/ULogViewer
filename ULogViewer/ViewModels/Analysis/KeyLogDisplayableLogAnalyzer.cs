...
class KeyLogDisplayableLogAnalyzer : RuleBasedDisplayableLogAnalyzer<KeyLogDisplayableLogAnalyzer.AnalyzingToken, KeyLogAnalysisRuleSet.Rule>
{
    ...
    public KeyLogDisplayableLogAnalyzer(IULogViewerApplication app, IList<DisplayableLog> sourceLogs, IDisplayableLogComparer comparer) : base(app, sourceLogs, comparer)
    { 
