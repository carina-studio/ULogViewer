...
class OperationDurationAnalysisRuleSet : DisplayableLogAnalysisRuleSet<OperationDurationAnalysisRuleSet.Rule>
{
    ...
    public class Rule : IEquatable<Rule>
    {
            ...
            string? quantityVarName)
        {
            ...
            this.BeginningConditions = ImmutableList.CreateRange(beginningConditions);
            this.BeginningPattern = beginningPattern;
            this.BeginningPostActions = ImmutableList.CreateRange(beginningPostActions);
            this.BeginningPreActions = ImmutableList.CreateRange(beginningPreActions);
            ...
            this.EndingConditions = ImmutableList.CreateRange(endingConditions);
            this.EndingMode = endingMode;
            this.EndingPattern = endingPattern;
            this.EndingPostActions = ImmutableList.CreateRange(endingPostActions);
            this.EndingPreActions = ImmutableList.CreateRange(endingPreActions);
            this.EndingVariables = ImmutableList.CreateRange(endingVars);
