...
class LogPropertyNameConverter : IValueConverter
{
	...
	/// Default instance.
	/// </summary>
	public static readonly LogPropertyNameConverter Default = new LogPropertyNameConverter(IULogViewerApplication.Current);
	...
	// Constructor.
	LogPropertyNameConverter(IULogViewerApplication app)
	{
		this.app = app;
	}
