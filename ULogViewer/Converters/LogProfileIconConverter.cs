...
class LogProfileIconConverter : IMultiValueConverter
{
	...
	/// Default instance.
	/// </summary>
	public static readonly LogProfileIconConverter Default = new((Avalonia.Application)IULogViewerApplication.Current);


	// Fields.
	readonly Avalonia.Application app;


	// Constructor.
	LogProfileIconConverter(Avalonia.Application app)
	{
		this.app = app;
	}
